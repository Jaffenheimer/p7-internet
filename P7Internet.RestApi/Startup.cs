    ...
    namespace Translation.RestApi
    {
        public class Startup
        {
            ...
            public void ConfigureServices(IServiceCollection services)
            {
                ...
                services.AddSingleton(new SallingService(Configuration.GetSection("Salling").GetValue<string>("APIKey"), HttpClientFactory.Create()));
                services.AddSingleton(new ETilbudsAvisService(Configuration.GetSection("Etilbudsavis").GetValue<string>("APIKey"), HttpClientFactory.Create()));
            }
