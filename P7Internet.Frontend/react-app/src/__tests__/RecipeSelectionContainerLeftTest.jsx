...
describe("integration tests for RecipeSelectionContainerLeft", () => {
  ...
  beforeEach(() => {
    const mockState = {
      ...
      recipe: {
        recipes: [
          {title: "Spaghetti", ingredients: ["400g spaghetti", "4 cloves"], method: ["cook spaghetti", "etc."]},
          {title: "Chicken Stir-Fry", ingredients: ["1 onion", "2 bell peppers"], method: ["heat", "etc."]}
        ],
